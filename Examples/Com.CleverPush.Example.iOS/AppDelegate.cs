...
namespace Com.CleverPush.Example.iOS
{
   ...
   public class AppDelegate : UIApplicationDelegate
   {
      ...
      [Export("cleverPushApplicationDidBecomeActive:")]
      public void CleverPushApplicationDidBecomeActive(UIApplication application)
      {
         // Remove line if you don't have a OnActivated method.
         OnActivated(application);
      }

      [Export("cleverPushApplicationWillResignActive:")]
      public void CleverPushApplicationWillResignActive(UIApplication application)
      {
         // Remove line if you don't have a OnResignActivation method.
         OnResignActivation(application);
      }

      [Export("cleverPushApplicationDidEnterBackground:")]
      public void CleverPushApplicationDidEnterBackground(UIApplication application)
      {
         // Remove line if you don't have a DidEnterBackground method.
         DidEnterBackground(application);
      }

      [Export("cleverPushApplicationWillTerminate:")]
      public void CleverPushApplicationWillTerminate(UIApplication application)
      {
